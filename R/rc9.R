...
#' @author Guy J. Abel
#' @seealso \code{\link{rc7}}, \code{\link{rc11}}, \code{\link{rc13}}
#' @export
#' @examples
#' #single year
#' f0 <- rc9(tot_mig = 100, x = seq(0, 100, 1),
#'           a1 = 0.02, alpha1 = 0.1,
...
#'
#' #five year
#' f1 <- rc9(tot_mig = 0.05, x = seq(0, 100, 5),
#'           a1 = 0.02, alpha1 = 0.1,
...
#' plot(f1, type = "l")
#' sum(f1)
rc9 <- function(tot_mig = 1, x = seq(from = 0, to = 100, by = 1),
                a1 = 0.02, alpha1 = 0.1,
                a2 = 0.06, mu2 = 20, alpha2 = 0.1, lambda2 = 0.4,
                a4 = 0, lambda4 = 0,
                c = 0.03,
