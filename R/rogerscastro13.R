#' Rogers-Castro Thirteen Parameter Migration Schedule.
#'
...
#'
#' The parameters relate to the heights (\code{a1}, \code{a2}, \code{a3}, \code{a4}, \code{c}), locations (\code{mu2}, \code{mu3}) and slopes (\code{alpha1}, \code{alpha2}, \code{lambda2}, \code{alpha3}, \code{lambda3}, \code{lambda4}).
#'
